    ...
    >
      ...
      options={{ 
        tabBarIcon: (color, size) => (
            <MaterialCommunityIcons name="account-circle" color={colors.primary} size={15} />
        ),
      ...
      <Tab.Screen name="Messages" component={MessagesScreen} 
       options={{ 
        tabBarIcon: (color, size) => (
            <MaterialCommunityIcons name="email-outline" color={colors.primary} size={15} />
        ),
      ...
      <Tab.Screen name="MyAccountSettings" component={MyAccountScreen} 
       options={{ 
        tabBarIcon: (color, size) => (
            <MaterialCommunityIcons name="settings" color={colors.primary} size={15} />
        ),
