...
const handleSubmit = async (recipe, {resetForm} ) => {
    ...
    async function storeImage(i) {
        console.log('store image promise', i)
    ...
    function doAsyncPromises(array) {
        ...
        for (let i = 0; i < array.length; i++) {
            ...
            promises.push(storeImage(image).then((result) => {
                const baseUrl = `https://prepcadoimages211300-dev.s3-us-west-2.amazonaws.com/public/` + recipe.name + 'Image' + i + '.png'
                return baseUrl
